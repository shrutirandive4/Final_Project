...
public class BookRecreationJPanel extends javax.swing.JPanel {
    ...
    private void btnBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBookActionPerformed
        ...
        String activity_name = (String) comboBoxRecreationName.getSelectedItem();
        String pickupTime = (String)comboBoxTime.getSelectedItem();
        String driverName = txtDate.getText();
        String travel_type = "Airport PickUp";
        
        TravelQueries tq = new TravelQueries();
        tq.scheduleAirportPickup(guestEmail, activity_name, pickupTime, travel_type, driverName);
